...
// node_modules/.pnpm/@storybook+addon-docs@8.0.5/node_modules/@storybook/addon-docs/dist/preview.mjs
...
var parameters = { docs: { renderer: async () => {
  let { DocsRenderer } = await import("./DocsRenderer-K4EAMTCU-RX26JWXD.js");
