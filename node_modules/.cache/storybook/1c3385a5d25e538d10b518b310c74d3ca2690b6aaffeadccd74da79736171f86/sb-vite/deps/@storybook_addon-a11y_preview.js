...
// node_modules/.pnpm/@storybook+addon-a11y@8.0.5/node_modules/@storybook/addon-a11y/dist/preview.js
...
var run = async (storyId, input = defaultParameters) => {
  ...
  try {
    if (!active) {
      ...
      let axe = (await import("./axe-AVXMFQVB.js")).default, { element = "#storybook-root", config, options = {} } = input, htmlElement = document.querySelector(element);
      if (!htmlElement)
        return;
