...
export const mockOptionsDefault = [
  {
    ...
    path: 'option1',
    customData: { origCode: 'OPT-001', code: 'OPT_001', erpId: "5", longDescription: 'Test 1 very very very very very very very very looooooo naaaaaaame. Test 1 very very very very very very very very looooooooooooooooong naaaaaaame', other: { countryCode: 'US' } },
    icon: '',
    selected: false,
    selectable: true,
    hierarchy: '',
  },
  {
    ...
    path: 'option2',
    customData: { origCode: 'OPT-002', code: 'OPT_002', erpId: "6", other: { countryCode: 'US' } },
    icon: '',
    selected: false,
    selectable: true,
    children: [
      {
        ...
        customData: { origCode: 'OPT-021', code: 'OPT_021', erpId: "7", other: { countryCode: 'US' } },
        icon: '',
        selected: false,
        selectable: true,
        hierarchy: '',
  ...
  },
  {
    ...
    path: 'option3',
    customData: { origCode: 'OPT-003', code: 'OPT_003', erpId: "8", other: { countryCode: 'US' } },
    icon: '',
    selected: false,
    selectable: true,
    children: [
      {
        ...
        selected: false,
        selectable: true,
        customData: { origCode: 'OPT-031', code: 'OPT_031', erpId: "8", other: { countryCode: 'US' } },
        children: [
          {
            id: 'id311',
            ...
            selectable: true,
            hierarchy: '',
            customData: { origCode: 'OPT-311', code: 'OPT_311', erpId: "8", other: { countryCode: 'US' } },
          },
          {
            id: 'id312',
            ...
            selectable: true,
            hierarchy: '',
            customData: { origCode: 'OPT-312', code: 'OPT_312', erpId: "8", other: { countryCode: 'US' } },
          },
          {
            id: 'id3122',
            ...
            selectable: true,
            hierarchy: '',
            customData: { origCode: 'OPT-313', code: 'OPT_313', erpId: "8", other: { countryCode: 'US' } },
          }
        ],
        hierarchy: '',
      }
