...
const formData: SoftwareFormDataV2 = {};
const currency = DEFAULT_CURRENCY;
const fields = [];

//👇 This default export determines where your story goes in the story list
export default {
  title: "ORO UI Toolkit/Form/Software Form v2/Edit",
  component: SoftwareFormV2,
};
...
export const TemplateForm = {
  args: {
    ...
    softwareSelectionOptions: [
      { id: "single", path: "single", displayName: "Single selection" },
      {
        id: "multi",
        path: "multi",
        displayName: "Multiple options for consideration",
      },
    ],
