...
import { BankInformationsUpdateFormReadOnly } from "../../lib";
...
export default {
  title: "ORO UI Toolkit/Form/Bank Info Update Form Read Only",
  component: BankInformationsUpdateFormReadOnly,
};
