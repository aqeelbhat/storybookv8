...
import { PaymentProviderConfirmationEmailTemplate } from "../../../lib/Form/CandexForm/PaymentProviderConfirmation-email.component";

export default {
  title: "ORO UI Toolkit/Form/Candex Form",
  component: PaymentProviderConfirmationEmailTemplate,
};
