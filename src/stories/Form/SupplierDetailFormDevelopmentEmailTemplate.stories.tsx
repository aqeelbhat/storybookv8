...
import { SupplierDetailFormDevelopmentEmailTemplate } from "./../../lib";
import { ActivationStatus, Supplier } from "../../lib/Types";

//👇 This default export determines where your story goes in the story list
export default {
  title: "ORO UI Toolkit/Form/Supplier Form development email template",
  component: SupplierDetailFormDevelopmentEmailTemplate,
};
