...
import { ShareHolderForm, getI18NInstance } from "./../../lib";
import { SupplierShareholdersFormProps } from "../../lib/Form/supplier-shareholders-form.component";
import { mockCountryOptions, mockRoleOptions } from "../MultiLevelSelect/mocks";

export default {
  title: "ORO UI Toolkit/Form/Supplier Shareholders",
...
export const TemplateForm = {
  args: {
    ...
    fields: [
      {
        ...
        fieldName: "minimumPercentageOwnership",
      ...
      {
        __typename: "FormField",
        fieldName: "shareHolderInformation",
        ...
        questionnaireId: null,
        customLabel: "Board of Directors",
      },
      {
        __typename: "FormField",
        fieldName: "keySubsidiariesAndJointVentureInformation",
        requirement: "required",
        booleanValue: false,
        stringValue: null,
        intValue: null,
        itemConfig: null,
        title: "Key subsidiaries or Joint ventures",
        questionnaireId: null,
      },
      {
        __typename: "FormField",
        fieldName: "subContractorInformation",
        requirement: "optional",
        booleanValue: false,
        stringValue: null,
        intValue: null,
      ...
      {
        __typename: "FormField",
        fieldName: "boardOfDirectorsInformation",
        requirement: "required",
        booleanValue: false,
        stringValue: null,
        intValue: null,
    ...
    processVariables: {
      assessOwnership: true,
      assessSubsidiary: true,
      assessSubcontractors: true,
    },
