...
import { mockUser } from "../../MultiLevelSelect/mocks";

const formData = {
  bookingPeriod: "2023-08-05",
  ...
  poNumber: "PO12345",
  details: "Thi sis commaerasjdsahd sjkdh ajskdhkasd sajkdd asd as d as",
};

export default {
  title: "ORO UI Toolkit/Form/Invoice Summary/Read Only",
