...
} from "../../lib/Form/companyIndividualInfoV2-form-read-only.component";
import {
  mockCountryOptions,
  mockOptionsDefault,
...
export default {
  title: "ORO UI Toolkit/Form/CompanyIndividualInfoV2 ReadOnly Form",
  component: CompanyIndividualInfoV2FormReadOnly,
};
