...
// import { TextPropsNew, TextAreaControlNew } from '../lib/controls/text.component';
...
//     const utils = render(<TextAreaControlNew placeholder={textProps.placeholder || 'Search'} value={textProps.value} config={{ forceValidate: (forceValidate) ? forceValidate : false, optional: (optional) ? optional : false, isReadOnly: (readonly) ? readonly : false }} onChange={handleChange} validator={textProps.validator} id={textProps.id} />)
...
//     test('TextArea field rendering value and checking validation correctly when field is mandatory and not readonly', () => {
...
//     test('TextArea field rendering value and checking validation correctly when field is mandatory and readonly', () => { 
//       const { input } = setupComponent(true, false)
//       fireEvent.change(input, { target: { value: '' } }) // changing the value to empty value
//       expect(handleChange).toHaveBeenCalled()
//       fireEvent.blur(input) // triggering blur event to fire the validation
//       expect(input).toHaveValue('')
...
//     test('TextArea field rendering value and checking validation correctly when field is not mandatory and readonly', () => {
