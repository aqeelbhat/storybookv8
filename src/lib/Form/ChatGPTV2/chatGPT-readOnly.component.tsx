...
import { ChatGPTV2FormData, ChatGPTReadOnlyFormProps } from "./types";
...
export function ChatGPTReadOnlyV2Form (props: ChatGPTReadOnlyFormProps) {
    const [attributes, setAttributes] = useState<Array<{ label: string, value: string }>>([])
    const formData = props.formData || {} as ChatGPTV2FormData;
