...
import { Field, UseFormProps, UseFormData } from './types'
...
export function UseFormComponent (props: UseFormProps) {
  ...
  function getFormData (): UseFormData {
    return {
      title,
      region,
      service,
  ...
  function getFormDataWithUpdatedValue (fieldName: string, newValue: string | Option | Option[]): UseFormData {
    const formData = JSON.parse(JSON.stringify(getFormData())) as UseFormData
  ...
  function fetchData (skipValidation?: boolean): UseFormData {
    if (skipValidation) {
      return getFormData()
    } else {
      const invalidFieldId = isFormInvalid()
    ...
    <div className={styles.projectDetailsForm}>
      <div className={styles.section} >
          ...
          <div className={styles.row} >
            <div className={classnames(styles.item, styles.col3)} id="title-field">
              <TextBox
                ...
                validator={(value) => validateField('title', 'Title', value)}
        ...
        { !isFieldOmitted('region') &&
          <div className={styles.row} >
            <div className={classnames(styles.item, styles.col2)} id="region-field">
              <TypeAhead
                label={t('--regionCountrySupplierUsed--')}
                ...
                validator={(value) => validateField('region', 'Region / country', value)}
        ...
        { !isFieldOmitted('service') &&
          <div className={styles.row} >
            <div className={classnames(styles.item, styles.col2)} id="service-field">
              <MultiSelect
                label={t('--servicesOfferedBySupplier--')}
                ...
                validator={(value) => validateField('service', 'Service / category', value)}
          ...
          <div className={styles.row} >
            <div className={classnames(styles.item, styles.col2)} id="subsidiary-field">
              <TypeAhead
                ...
                validator={(value) => validateField('subsidiary', 'Primary business entity', value)}
        ...
        { !isFieldOmitted('additionalSubsidiary') &&
          <div className={styles.row} >
            <div className={classnames(styles.item, styles.col2)} id="additional-subsidiary-field">
              <MultiSelect
                label={t('--additionalBusinessEntity--')}
                placeholder={t('--chooseAdditionalBusinessEntities--')}
                type={OptionTreeData.entity}
                ...
                fetchChildren={(parent, childrenLevel) => fetchChildren('CompanyEntity', parent, childrenLevel)}
                onSearch={(keyword) => searchMasterdataOptions(keyword, 'CompanyEntity')}
                validator={(value) => validateField('additionalSubsidiary', 'Additional business entity', value)}
        ...
        <div className={styles.row} >
          ...
          { !isFieldOmitted('department') &&
            <div className={classnames(styles.item, styles.col1)} id="department-field">
              <TypeAhead
                label={t('--department--')}
                value={department}
                ...
                validator={(value) => validateField('department', 'Department', value)}
          ...
          <div className={styles.row} >
            <div className={classnames(styles.item, styles.col3)} id="comment-field">
              <TextArea
                ...
                placeholder={t('--addDetailsAboutBusinessNeed--')}
                value={comment}
                disabled={isFieldDisabled('comment')}
                required={isFieldRequired('comment')}
                forceValidate={forceValidate}
                validator={(value) => validateField('comment', 'Comment / details', value)}
...
export function UseForm (props: UseFormProps) {
  return <I18Suspense><UseFormComponent  {...props} /></I18Suspense>
}