...
import { CompanyInfoV2FormData, EnumsDataObject } from './types'
...
interface CompanyInfoV2FormEmailProps {
...
export function CompanyInfoV2FormEmail (props: CompanyInfoV2FormEmailProps) {
    ...
    <div className="emailTemplate">
      ...
      <table>
        <tbody>
          ...
          <tr className="marginB6">
            <td align="left"><div className="emailLabelText">DUNS number</div></td>
            <td align="left"><div className="emailLabelValue">{props.data.duns || '-'}</div></td>
          </tr>
          <tr className="marginB6">
            <td align="left"><div className="emailLabelText">Email</div></td>
            <td align="left"><div className="emailLabelValue">{props.data?.email || '-'}</div></td>
          </tr>
          <tr className="marginB6">
            <td align="left"><div className="emailLabelText">Phone</div></td>
      ...
      <table>
        ...
        { props.data?.indirectTaxKey &&
            <tr className="marginB6">
              <td align="left"><div className="emailLabelText">{getTaxKeyNameForKey(props.data?.indirectTaxKey) || 'Tax Code'}</div></td>
              <td align="left">
                <div className="emailLabelValue">
          ...
          { props.data?.usTaxDeclarationFormKey && props.data?.usTaxDeclarationForm &&
            <>
              <tr>
                <td>
                  <div className="fieldTitle">{getTaxFormNameForKey(props.data?.usTaxDeclarationFormKey) || 'Tax Form'} :</div>
                </td>
              </tr>
              <tr>
                <td colSpan={2}>
          ...
          { props.data?.exemptionTaxKey &&
            <tr className="marginB6">
              <td align="left"><div className="emailLabelText">{getTaxKeyNameForKey(props.data?.exemptionTaxKey) || 'Tax Code'}</div></td>
              <td align="left">
                <div className="emailLabelValue">
          ...
          <tr className="marginB6">
            <td align="left"><div className="emailLabelText">Instruction</div></td>
