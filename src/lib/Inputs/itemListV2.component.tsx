...
import { ItemDetailsControlV2 } from '../controls/itemDetailsV2/Index'
...
interface ItemListProps {
  ...
  validator?: (value?: ItemListType) => IValidationV2Response
...
export function ItemListV2 (props: ItemListProps) {
  ...
  useEffect(() => {
    if (!props.skipValidator && props.forceValidate && props.validator) {
      ...
      setError(err.hasError ? err.errorMessage : '')
    }
  }, [props.forceValidate])
